...
#ifndef BROADCASTUPLOADEXTENSION_SWIFT_H
#define BROADCASTUPLOADEXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BroadcastUploadExtension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSObject;
SWIFT_CLASS("_TtC24BroadcastUploadExtension13SampleHandler")
